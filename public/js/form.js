...
function verificarImagem() {
    ...
    if (!arquivo) {
      // A imagem está vazia
      // Use o valor armazenado no banco de dados
      document.querySelector("#imagem-preview").src = "<?php echo $foto ?>";
    } else {
      // A imagem não está vazia
      // Use a imagem selecionada
      document.querySelector("#imagem-preview").src = URL.createObjectURL(arquivo);
    }
  }
  
  document.querySelector("#imagem").addEventListener("change", verificarImagem)


// $('.add-more').click(function () {
//   $('.xp').append('<div id="experiencia-grup"><label for="experiencia">Experiencia(s):</label>
//   <input type="text" id="experiencia" name="experiencia[]" value="<?php echo $experiencia?>" placeholder="Nos diga quais as suas experiencias"></div>')
// })